...
html`<button onclick="${() => {
  if (confirm('Reset all responses for this activity? This cannot be undone.')) {
    Object.keys(localStorage)
      .filter(k => k.endsWith('_selected') || k.endsWith('_correct') || k.endsWith('_result'))
...

{
  ...
  localStorage.setItem("q1_correct", "3,4,5");
  localStorage.setItem("q1_result", (!q1 || q1.length === 0) ? "unattempted" : (q1.toString() === "3,4,5" ? "correct" : "incorrect"));
}
...

{
  ...
  localStorage.setItem("q2_correct", "2,6,7");
  localStorage.setItem("q2_result", (!q2 || q2.length === 0) ? "unattempted" : (q2.toString() === "2,6,7" ? "correct" : "incorrect"));
}
...

{
  ...
  localStorage.setItem("q3_result", (!q3 || q3.length === 0) ? "unattempted" : (q3.toString() === "1" ? "correct" : "incorrect"));
}
ok_checkbox(q3, "1");
```
