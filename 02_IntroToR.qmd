...
R has built in functions to handle operations like the square root (`sqrt()`), logarithm (`log()`), etc. A web search can be helpful here -- if you need to carry out an operation, do a quick internet search to discover how you can call it in R.
...
While we are unlikely to encounter these issues in our course, it is still worth calling out here.
:::
