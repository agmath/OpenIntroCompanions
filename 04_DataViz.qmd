...

{
  ...
  localStorage.setItem("q1_correct", "2,3");
  localStorage.setItem("q1_result", (!q1 || q1.length === 0) ? "unattempted" : (q1.toString() === "2,3" ? "correct" : "incorrect"));
}
ok_checkbox(q1, "2,3");
```
...

{
  ...
  localStorage.setItem("q4_correct", "3,4,6,8,9");
  localStorage.setItem("q4_result", (!q4 || q4.length === 0) ? "unattempted" : (q4.toString() === "3,4,6,8,9" ? "correct" : "incorrect"));
}
...

{
  ...
  localStorage.setItem("q9_correct", "3,4,5");
  localStorage.setItem("q9_result", (!q9 || q9.length === 0) ? "unattempted" : (q9.toString() === "3,4,5" ? "correct" : "incorrect"));
}
