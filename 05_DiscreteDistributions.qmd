...
That call calculates the probability of 0 through 11 successes. That's not what we want. Could we start with the probability of all possible outcomes and then remove the ones we don't want?
...
Think carefully about which events we need to remove. What number goes in the blank?
