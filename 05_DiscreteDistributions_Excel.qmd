  ...
  btn.onclick = () => {
    if (confirm('Reset all responses for this activity? This cannot be undone.')) {
      Object.keys(localStorage)
        .filter(k => k.endsWith('_selected_t5e') || k.endsWith('_correct_t5e') || k.endsWith('_result_t5e'))
...
viewof q1 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q1_selected_t5e") ?? "null")}
);

{
  localStorage.setItem("q1_selected_t5e", JSON.stringify(q1));
  localStorage.setItem("q1_correct_t5e", "2");
  localStorage.setItem("q1_result_t5e", q1 === null ? "unattempted" : (q1 == 2 ? "correct" : "incorrect"));
}
ok_response(q1, "2");
```
...
viewof q2 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q2_selected_t5e") ?? "null")}
);

{
  localStorage.setItem("q2_selected_t5e", JSON.stringify(q2));
  localStorage.setItem("q2_correct_t5e", "4");
  localStorage.setItem("q2_result_t5e", q2 === null ? "unattempted" : (q2 == 4 ? "correct" : "incorrect"));
}
ok_response(q2, "4");
```
...
viewof q3 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q3_selected_t5e") ?? "null")}
);

{
  localStorage.setItem("q3_selected_t5e", JSON.stringify(q3));
  localStorage.setItem("q3_correct_t5e", "2");
  localStorage.setItem("q3_result_t5e", q3 === null ? "unattempted" : (q3 == 2 ? "correct" : "incorrect"));
}
ok_response(q3, "2");
```
...
viewof q4 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q4_selected_t5e") ?? "null")}
);

{
  localStorage.setItem("q4_selected_t5e", JSON.stringify(q4));
  localStorage.setItem("q4_correct_t5e", "6");
  localStorage.setItem("q4_result_t5e", q4 === null ? "unattempted" : (q4 == 6 ? "correct" : "incorrect"));
}
ok_response(q4, "6");
```
...
viewof q5 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q5_selected_t5e") ?? "null")}
);

{
  localStorage.setItem("q5_selected_t5e", JSON.stringify(q5));
  localStorage.setItem("q5_correct_t5e", "2");
  localStorage.setItem("q5_result_t5e", q5 === null ? "unattempted" : (q5 == 2 ? "correct" : "incorrect"));
}
ok_response(q5, "2");
```
...
viewof q6 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q6_selected_t5e") ?? "null")}
);

{
  localStorage.setItem("q6_selected_t5e", JSON.stringify(q6));
  localStorage.setItem("q6_correct_t5e", "3");
  localStorage.setItem("q6_result_t5e", q6 === null ? "unattempted" : (q6 == 3 ? "correct" : "incorrect"));
}
ok_response(q6, "3");
```
...
viewof q7 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q7_selected_t5e") ?? "null")}
);

{
  localStorage.setItem("q7_selected_t5e", JSON.stringify(q7));
  localStorage.setItem("q7_correct_t5e", "2");
  localStorage.setItem("q7_result_t5e", q7 === null ? "unattempted" : (q7 == 2 ? "correct" : "incorrect"));
}
ok_response(q7, "2");
```
...
viewof q8 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q8_selected_t5e") ?? "null")}
);

{
  localStorage.setItem("q8_selected_t5e", JSON.stringify(q8));
  localStorage.setItem("q8_correct_t5e", "5");
  localStorage.setItem("q8_result_t5e", q8 === null ? "unattempted" : (q8 == 5 ? "correct" : "incorrect"));
}
ok_response(q8, "5");
```
...
viewof q9 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q9_selected_t5e") ?? "null")}
);

{
  localStorage.setItem("q9_selected_t5e", JSON.stringify(q9));
  localStorage.setItem("q9_correct_t5e", "3");
  localStorage.setItem("q9_result_t5e", q9 === null ? "unattempted" : (q9 == 3 ? "correct" : "incorrect"));
}
ok_response(q9, "3");
```
...
viewof q10 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q10_selected_t5e") ?? "null")}
);

{
  localStorage.setItem("q10_selected_t5e", JSON.stringify(q10));
  localStorage.setItem("q10_correct_t5e", "8");
  localStorage.setItem("q10_result_t5e", q10 === null ? "unattempted" : (q10 == 8 ? "correct" : "incorrect"));
}
ok_response(q10, "8");
```
