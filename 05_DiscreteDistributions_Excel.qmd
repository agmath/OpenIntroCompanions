---
title: "Topic 5: Discrete Probability Distributions (Spreadsheets, Static)"
format: 
  live-html:
    include-in-header:
      text: |
...
exercise_results <- list(
  notebook              = "Topic 5: Discrete Probability Distributions (Spreadsheets, Static)",
  ...
  btn.onclick = () => {
    if (confirm('Reset all responses for this activity? This cannot be undone.')) {
      Object.keys(localStorage)
        .filter(k => k.endsWith('_selected_t5') || k.endsWith('_correct_t5') || k.endsWith('_result_t5'))
...
viewof q1 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q1_selected_t5") ?? "null")}
);

{
  localStorage.setItem("q1_selected_t5", JSON.stringify(q1));
  localStorage.setItem("q1_correct_t5", "2");
  localStorage.setItem("q1_result_t5", q1 === null ? "unattempted" : (q1 == 2 ? "correct" : "incorrect"));
}
ok_response(q1, "2");
```
...
viewof q2 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q2_selected_t5") ?? "null")}
);

{
  localStorage.setItem("q2_selected_t5", JSON.stringify(q2));
  localStorage.setItem("q2_correct_t5", "4");
  localStorage.setItem("q2_result_t5", q2 === null ? "unattempted" : (q2 == 4 ? "correct" : "incorrect"));
}
ok_response(q2, "4");
```
...
viewof q3 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q3_selected_t5") ?? "null")}
);

{
  localStorage.setItem("q3_selected_t5", JSON.stringify(q3));
  localStorage.setItem("q3_correct_t5", "2");
  localStorage.setItem("q3_result_t5", q3 === null ? "unattempted" : (q3 == 2 ? "correct" : "incorrect"));
}
ok_response(q3, "2");
```
...
viewof q4 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q4_selected_t5") ?? "null")}
);

{
  localStorage.setItem("q4_selected_t5", JSON.stringify(q4));
  localStorage.setItem("q4_correct_t5", "6");
  localStorage.setItem("q4_result_t5", q4 === null ? "unattempted" : (q4 == 6 ? "correct" : "incorrect"));
}
ok_response(q4, "6");
```
...
viewof q5 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q5_selected_t5") ?? "null")}
);

{
  localStorage.setItem("q5_selected_t5", JSON.stringify(q5));
  localStorage.setItem("q5_correct_t5", "2");
  localStorage.setItem("q5_result_t5", q5 === null ? "unattempted" : (q5 == 2 ? "correct" : "incorrect"));
}
ok_response(q5, "2");
```
...
viewof q6 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q6_selected_t5") ?? "null")}
);

{
  localStorage.setItem("q6_selected_t5", JSON.stringify(q6));
  localStorage.setItem("q6_correct_t5", "3");
  localStorage.setItem("q6_result_t5", q6 === null ? "unattempted" : (q6 == 3 ? "correct" : "incorrect"));
}
ok_response(q6, "3");
```
...
viewof q7 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q7_selected_t5") ?? "null")}
);

{
  localStorage.setItem("q7_selected_t5", JSON.stringify(q7));
  localStorage.setItem("q7_correct_t5", "2");
  localStorage.setItem("q7_result_t5", q7 === null ? "unattempted" : (q7 == 2 ? "correct" : "incorrect"));
}
ok_response(q7, "2");
```
...
viewof q8 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q8_selected_t5") ?? "null")}
);

{
  localStorage.setItem("q8_selected_t5", JSON.stringify(q8));
  localStorage.setItem("q8_correct_t5", "5");
  localStorage.setItem("q8_result_t5", q8 === null ? "unattempted" : (q8 == 5 ? "correct" : "incorrect"));
}
ok_response(q8, "5");
```
...
viewof q9 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q9_selected_t5") ?? "null")}
);

{
  localStorage.setItem("q9_selected_t5", JSON.stringify(q9));
  localStorage.setItem("q9_correct_t5", "3");
  localStorage.setItem("q9_result_t5", q9 === null ? "unattempted" : (q9 == 3 ? "correct" : "incorrect"));
}
ok_response(q9, "3");
```
...
viewof q10 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q10_selected_t5") ?? "null")}
);

{
  localStorage.setItem("q10_selected_t5", JSON.stringify(q10));
  localStorage.setItem("q10_correct_t5", "8");
  localStorage.setItem("q10_result_t5", q10 === null ? "unattempted" : (q10 == 8 ? "correct" : "incorrect"));
}
ok_response(q10, "8");
```
...
2. Find the probability that exactly 7 of the 18 students have failed to hand in at least one assignment. Do the calculations in your spreadsheet, then enter your result below.
...
3. Find the probability that at most 9 of the 18 students have failed to hand in at least one assignment. Do the calculations in your spreadsheet, then enter your result below.
...
4. Find the probability that at least 11 of the 18 students have failed to hand in at least one assignment. Do the calculations in your spreadsheet, then enter your result below.
...
5. Find the probability that between a minimum of 6 and a maximum of 12 out of the 18 students have failed to hand in at least one assignment. Do the calculations in your spreadsheet, then enter your result below.
...
7. The standard deviation in the number of successes for a binomial experiment can also be computed. The quantity $\displaystyle{s_X = \sqrt{n\cdot p\left(1 - p\right)}}$, where $n$ denotes the number of trials run and $p$ denotes the probability of success on a single trial, is the standard deviation in number of successes. Use your spreadsheet to compute the standard deviation in number of students who have failed to hand in at least one assignment from random samples of 18 students, then enter your result below.
...
function buildQuestionResults() {
  return {
    notebook: "Topic 5: Discrete Probability Distributions (Excel, Static)",
    type: "questions",
