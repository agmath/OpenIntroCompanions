  ...
  btn.onclick = () => {
    if (confirm('Reset all responses for this activity? This cannot be undone.')) {
      Object.keys(localStorage)
        .filter(k => k.endsWith('_selected_t6e') || k.endsWith('_correct_t6e') || k.endsWith('_result_t6e'))
...
viewof q1 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q1_selected_t6e") ?? "null")}
);

{
  localStorage.setItem("q1_selected_t6e", JSON.stringify(q1));
  localStorage.setItem("q1_correct_t6e", "2");
  localStorage.setItem("q1_result_t6e", q1 === null ? "unattempted" : (q1 == 2 ? "correct" : "incorrect"));
}
ok_response(q1, "2");
```
...
viewof q2 = Inputs.checkbox(
  ...
  {value: JSON.parse(localStorage.getItem("q2_selected_t6e") ?? "[]") ?? []}
);

{
  localStorage.setItem("q2_selected_t6e", JSON.stringify(q2));
  localStorage.setItem("q2_correct_t6e", "3,6");
  localStorage.setItem("q2_result_t6e", (!q2 || q2.length === 0) ? "unattempted" : (q2.toString() === "3,6" ? "correct" : "incorrect"));
}
ok_checkbox(q2, "3,6");
```
...
viewof q3 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q3_selected_t6e") ?? "null")}
);

{
  localStorage.setItem("q3_selected_t6e", JSON.stringify(q3));
  localStorage.setItem("q3_correct_t6e", "1");
  localStorage.setItem("q3_result_t6e", q3 === null ? "unattempted" : (q3 == 1 ? "correct" : "incorrect"));
}
ok_response(q3, "1");
```
...
viewof q4 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q4_selected_t6e") ?? "null")}
);

{
  localStorage.setItem("q4_selected_t6e", JSON.stringify(q4));
  localStorage.setItem("q4_correct_t6e", "4");
  localStorage.setItem("q4_result_t6e", q4 === null ? "unattempted" : (q4 == 4 ? "correct" : "incorrect"));
}
ok_response(q4, "4");
```
...
viewof q5 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q5_selected_t6e") ?? "null")}
);

{
  localStorage.setItem("q5_selected_t6e", JSON.stringify(q5));
  localStorage.setItem("q5_correct_t6e", "1");
  localStorage.setItem("q5_result_t6e", q5 === null ? "unattempted" : (q5 == 1 ? "correct" : "incorrect"));
}
ok_response(q5, "1");
```
...
viewof q6 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q6_selected_t6e") ?? "null")}
);

{
  localStorage.setItem("q6_selected_t6e", JSON.stringify(q6));
  localStorage.setItem("q6_correct_t6e", "1");
  localStorage.setItem("q6_result_t6e", q6 === null ? "unattempted" : (q6 == 1 ? "correct" : "incorrect"));
}
ok_response(q6, "1");
```
...
viewof q7 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q7_selected_t6e") ?? "null")}
);

{
  localStorage.setItem("q7_selected_t6e", JSON.stringify(q7));
  localStorage.setItem("q7_correct_t6e", "4");
  localStorage.setItem("q7_result_t6e", q7 === null ? "unattempted" : (q7 == 4 ? "correct" : "incorrect"));
}
ok_response(q7, "4");
```
...
viewof q8 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q8_selected_t6e") ?? "null")}
);

{
  localStorage.setItem("q8_selected_t6e", JSON.stringify(q8));
  localStorage.setItem("q8_correct_t6e", "1");
  localStorage.setItem("q8_result_t6e", q8 === null ? "unattempted" : (q8 == 1 ? "correct" : "incorrect"));
}
ok_response(q8, "1");
```
...
**Practice Problem 1:** The National Vaccine Information Center estimates that 90% of Americans have had chickenpox by the time they reach adulthood. Suppose we take a random sample of `{ojs} chickPoxSampSize` American adults. Answer each of the following, making use of your spreadsheet functionality where appropriate.
...
viewof q9 = Inputs.checkbox(
  ...
  {value: JSON.parse(localStorage.getItem("q9_selected_t6e") ?? "[]") ?? []}
);

{
  localStorage.setItem("q9_selected_t6e", JSON.stringify(q9));
  localStorage.setItem("q9_correct_t6e", "1,2");
  localStorage.setItem("q9_result_t6e", (!q9 || q9.length === 0) ? "unattempted" : (q9.toString() === "1,2" ? "correct" : "incorrect"));
}
ok_checkbox(q9, "1,2");
```
...
In your spreadsheet, type `=BINOM.DIST(___, 68, 0.90, TRUE) - BINOM.DIST(___, 68, 0.90, TRUE)`Z. The first blanks are filled in by `{ojs} Number(chickPox_between_hi) - 1` and `{ojs} chickPox_between_lo`, respectively, and press Enter. Input the result.
...
gradethis::grade_this({
  if (abs(.result - ((157 - 153) / 7.67)) < 0.005) {
...
viewof q10 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q10_selected_t6e") ?? "null")}
);

{
  localStorage.setItem("q10_selected_t6e", JSON.stringify(q10));
  localStorage.setItem("q10_correct_t6e", "1");
  localStorage.setItem("q10_result_t6e", q10 === null ? "unattempted" : (q10 == 1 ? "correct" : "incorrect"));
}
ok_response(q10, "1");
```
...
3. Find the proportion of test takers that Sophia scored higher than on the Quantitative Reasoning exam (that is, find her percentile). Enter your result below.
...
gradethis::grade_this({
  if (abs(.result - pnorm(157, 153, 7.67)) < 0.0005) {
...
gradethis::grade_this({
  if (abs(.result - (1 - pnorm(160, 151, 7))) < 0.0005) {
