...
Basketball players who make several baskets in succession are often described as having a *hot hand*. Fans and players have long believed in the *hot hand* phenomenon, which refutes the assumption that each shot is independent of the next. However, a 1985 paper by Gilovich, Vallone, and Tversky collected evidence that contradicted this belief and showed that successive shots are indeed independent events ([link to paper](http://psych.cornell.edu/sites/default/files/Gilo.Vallone.Tversky.pdf){target="_blank"}). This paper started a great controversy that continues to this day, as you can see by Googling *hot hand basketball*.
...
3. compare a simulation to actual data in order to determine if the hot hand phenomenon appears to be real.
