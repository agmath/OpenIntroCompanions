...
**Question 1:** In the first paragraph, several key findings are reported. Do these percentages appear to be *sample statistics* (derived from the data sample) or *population parameters*?
...
**Question 2:** The title of the report is Global Index of Religiosity and Atheism. To generalize the report’s findings to the global human population, what must we assume about the sampling method?
...
**Question 3:** Do you expect that the required assumption was satisfied? What are the implications of this?
...
**Question 4:** What does each row of `Table 6` correspond to? What does each row of the `atheism` data frame correspond to?
...
**Question 5:** Based on the R output, what is the margin of error for the estimate of the proportion of the proportion of atheists in US in 2012?
...
**Question 6:** Describe the relationship between the population proportion, $p$, and margin of error.
...
**Question 7:** Which of the following are implications of your answer above?
