...
exercise_results <- list(
  ...
  exp_white         = "unattempted",
  exp_black         = "unattempted",
  exp_hispanic      = "unattempted",
  exp_other         = "unattempted",
  test_stat         = "unattempted",
  df                = "unattempted",
  compute_p         = "unattempted",
  poverty_drug_use  = "unattempted",
  lowInc_drug_use   = "unattempted",
  middleInc_drug_use = "unattempted",
  highInc_drug_use  = "unattempted",
  chi_sq_ind        = "unattempted",
  df_ind            = "unattempted",
  compute_p_indep   = "unattempted"
)
```
  ...
  btn.onclick = () => {
    if (confirm('Reset all responses for this activity? This cannot be undone.')) {
      Object.keys(localStorage)
        .filter(k => k.endsWith('_selected_t14') || k.endsWith('_correct_t14') || k.endsWith('_result_t14'))
...
:::{.callout-caution}
## Check Your Understanding: Goodness of Fit I
...
viewof q1 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q1_selected_t14") ?? "null")}
);

{
  localStorage.setItem("q1_selected_t14", JSON.stringify(q1));
  localStorage.setItem("q1_correct_t14", "1");
  localStorage.setItem("q1_result_t14", q1 === null ? "unattempted" : (q1 == 1 ? "correct" : "incorrect"));
}
ok_response(q1, "1");
```
...
:::{.callout-caution}
## Check Your Understanding: Goodness of Fit II
...
viewof q2 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q2_selected_t14") ?? "null")}
);

{
  localStorage.setItem("q2_selected_t14", JSON.stringify(q2));
  localStorage.setItem("q2_correct_t14", "2");
  localStorage.setItem("q2_result_t14", q2 === null ? "unattempted" : (q2 == 2 ? "correct" : "incorrect"));
}
ok_response(q2, "2");
```
...
:::{.callout-caution}
## Check Your Understanding: Goodness of Fit III
...
viewof q3 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q3_selected_t14") ?? "null")}
);

{
  localStorage.setItem("q3_selected_t14", JSON.stringify(q3));
  localStorage.setItem("q3_correct_t14", "4");
  localStorage.setItem("q3_result_t14", q3 === null ? "unattempted" : (q3 == 4 ? "correct" : "incorrect"));
}
ok_response(q3, "4");
```
...
:::{.callout-caution}
## Check Your Understanding: Goodness of Fit IV
...
viewof q4 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q4_selected_t14") ?? "null")}
);

{
  localStorage.setItem("q4_selected_t14", JSON.stringify(q4));
  localStorage.setItem("q4_correct_t14", "2");
  localStorage.setItem("q4_result_t14", q4 === null ? "unattempted" : (q4 == 2 ? "correct" : "incorrect"));
}
ok_response(q4, "2");
```
...
:::{.callout-caution}
## Check Your Understanding: Goodness of Fit V
...
viewof q5 = Inputs.checkbox(
  ...
  {value: JSON.parse(localStorage.getItem("q5_selected_t14") ?? "[]") ?? []}
);

{
  localStorage.setItem("q5_selected_t14", JSON.stringify(q5));
  localStorage.setItem("q5_correct_t14", "2,5");
  localStorage.setItem("q5_result_t14", (!q5 || q5.length === 0) ? "unattempted" : (q5.toString() === "2,5" ? "correct" : "incorrect"));
}
...
exercise_results$exp_white <<- "fail"
gradethis::grade_this({
  if (abs(.result - 300 * 0.898) < 0.01) {
    exercise_results$exp_white <<- "pass"
    pass(random_praise())
  }
...
exercise_results$exp_black <<- "fail"
gradethis::grade_this({
  if (abs(.result - 300 * 0.018) < 0.01) {
    exercise_results$exp_black <<- "pass"
    pass(random_praise())
  }
  fail(random_encouragement())
})
...
exercise_results$exp_hispanic <<- "fail"
gradethis::grade_this({
  if (abs(.result - 300 * 0.040) < 0.01) {
    exercise_results$exp_hispanic <<- "pass"
    pass(random_praise())
  }
  fail(random_encouragement())
})
...
exercise_results$exp_other <<- "fail"
gradethis::grade_this({
  if (abs(.result - 300 * 0.044) < 0.01) {
    exercise_results$exp_other <<- "pass"
    pass(random_praise())
  }
  fail(random_encouragement())
})
...
exercise_results$test_stat <<- "fail"
gradethis::grade_this({
  observed <- c(243, 24, 15, 18)
  expected <- c(269.4, 5.4, 12.0, 13.2)
  if (abs(.result - sum((observed - expected)^2 / expected)) < 0.01) {
    exercise_results$test_stat <<- "pass"
    pass(random_praise())
  }
  fail(random_encouragement())
})
...
exercise_results$df <<- "fail"
gradethis::grade_this({
  if (.result == 3) {
    exercise_results$df <<- "pass"
    pass(random_praise())
  }
  fail(random_encouragement())
})
...
exercise_results$compute_p <<- "fail"
gradethis::grade_this({
  if (abs(.result - (1 - pchisq(69.15, df = 3))) < 0.0001) {
    exercise_results$compute_p <<- "pass"
    pass(random_praise())
  }
  fail(random_encouragement())
})
...
:::{.callout-caution}
## Check Your Understanding: Goodness of Fit VI
...
viewof q6 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q6_selected_t14") ?? "null")}
);

{
  localStorage.setItem("q6_selected_t14", JSON.stringify(q6));
  localStorage.setItem("q6_correct_t14", "3");
  localStorage.setItem("q6_result_t14", q6 === null ? "unattempted" : (q6 == 3 ? "correct" : "incorrect"));
}
ok_response(q6, "3");
```
...
:::{.callout-caution}
## Check Your Understanding: Goodness of Fit VII
...
viewof q7 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q7_selected_t14") ?? "null")}
);

{
  localStorage.setItem("q7_selected_t14", JSON.stringify(q7));
  localStorage.setItem("q7_correct_t14", "3");
  localStorage.setItem("q7_result_t14", q7 === null ? "unattempted" : (q7 == 3 ? "correct" : "incorrect"));
}
ok_response(q7, "3");
```
...
viewof q8 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q8_selected_t14") ?? "null")}
);

{
  localStorage.setItem("q8_selected_t14", JSON.stringify(q8));
  localStorage.setItem("q8_correct_t14", "2");
  localStorage.setItem("q8_result_t14", q8 === null ? "unattempted" : (q8 == 2 ? "correct" : "incorrect"));
}
ok_response(q8, "2");
```
...
viewof q9 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q9_selected_t14") ?? "null")}
);

{
  localStorage.setItem("q9_selected_t14", JSON.stringify(q9));
  localStorage.setItem("q9_correct_t14", "2");
  localStorage.setItem("q9_result_t14", q9 === null ? "unattempted" : (q9 == 2 ? "correct" : "incorrect"));
}
ok_response(q9, "2");
```
...
viewof q10 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q10_selected_t14") ?? "null")}
);

{
  localStorage.setItem("q10_selected_t14", JSON.stringify(q10));
  localStorage.setItem("q10_correct_t14", "2");
  localStorage.setItem("q10_result_t14", q10 === null ? "unattempted" : (q10 == 2 ? "correct" : "incorrect"));
}
ok_response(q10, "2");
```
...
viewof q11 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q11_selected_t14") ?? "null")}
);

{
  localStorage.setItem("q11_selected_t14", JSON.stringify(q11));
  localStorage.setItem("q11_correct_t14", "1");
  localStorage.setItem("q11_result_t14", q11 === null ? "unattempted" : (q11 == 1 ? "correct" : "incorrect"));
}
ok_response(q11, "1");
```
...
$$\text{Expected Count} = \mathbb{P}\left[\text{poverty}\right]\cdot \mathbb{P}\left[\text{drug use}\right]\cdot n$$
...
exercise_results$poverty_drug_use <<- "fail"
gradethis::grade_this({
  if (abs(.result - 2500 * 0.16 * 0.14) < 0.5) {
    exercise_results$poverty_drug_use <<- "pass"
    pass(random_praise())
  }
  fail(random_encouragement())
})
...
exercise_results$lowInc_drug_use <<- "fail"
gradethis::grade_this({
  if (abs(.result - 2500 * 0.38 * 0.14) < 0.5) {
    exercise_results$lowInc_drug_use <<- "pass"
    pass(random_praise())
  }
  fail(random_encouragement())
})
...
exercise_results$middleInc_drug_use <<- "fail"
gradethis::grade_this({
  if (abs(.result - 2500 * 0.35 * 0.14) < 0.5) {
    exercise_results$middleInc_drug_use <<- "pass"
    pass(random_praise())
  }
  fail(random_encouragement())
})
...
exercise_results$highInc_drug_use <<- "fail"
gradethis::grade_this({
  if (abs(.result - 2500 * 0.11 * 0.14) < 0.5) {
    exercise_results$highInc_drug_use <<- "pass"
    pass(random_praise())
  }
  fail(random_encouragement())
})
...
exercise_results$chi_sq_ind <<- "fail"
gradethis::grade_this({
  if (abs(.result - 21.24924) < 0.05) {
    exercise_results$chi_sq_ind <<- "pass"
    pass(random_praise())
  }
  fail(random_encouragement())
})
...
exercise_results$df_ind <<- "fail"
gradethis::grade_this({
  if (.result == 3) {
    exercise_results$df_ind <<- "pass"
    pass(random_praise())
  }
  fail(random_encouragement())
})
...
exercise_results$compute_p_indep <<- "fail"
gradethis::grade_this({
  if (abs(.result - (1 - pchisq(21.24924, 3))) < 0.001) {
    exercise_results$compute_p_indep <<- "pass"
    pass(random_praise())
  }
  fail(random_encouragement())
})
...
viewof q12 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q12_selected_t14") ?? "null")}
);

{
  localStorage.setItem("q12_selected_t14", JSON.stringify(q12));
  localStorage.setItem("q12_correct_t14", "3");
  localStorage.setItem("q12_result_t14", q12 === null ? "unattempted" : (q12 == 3 ? "correct" : "incorrect"));
}
ok_response(q12, "3");
```
...
viewof q13 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q13_selected_t14") ?? "null")}
);

{
  localStorage.setItem("q13_selected_t14", JSON.stringify(q13));
  localStorage.setItem("q13_correct_t14", "1");
  localStorage.setItem("q13_result_t14", q13 === null ? "unattempted" : (q13 == 1 ? "correct" : "incorrect"));
}
ok_response(q13, "1");
```
