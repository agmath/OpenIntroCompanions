...
exercise_results <- list(
  notebook                          = "Topic 17: Inference for Numerical Data (Lab)",
  plot_habit_weight                 = "unattempted",
  check_inference_conditions_habit  = "unattempted",
  first_inference_run               = "unattempted"
)
```
...
In this lab, we work with data on 1,000 pregnancies recorded in North Carolina during the year 2004. We revisit the `inference()` function from the `{statsr}` package — this time applying it to numerical data. We'll conduct hypothesis tests and construct confidence intervals for means.
  ...
  btn.onclick = () => {
    if (confirm('Reset all responses for this activity? This cannot be undone.')) {
      Object.keys(localStorage)
        .filter(k => k.endsWith('_selected_t17') || k.endsWith('_correct_t17') || k.endsWith('_result_t17'))
...
viewof q1 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q1_selected_t17") ?? "null")}
);

{
  localStorage.setItem("q1_selected_t17", JSON.stringify(q1));
  localStorage.setItem("q1_correct_t17", "1");
  localStorage.setItem("q1_result_t17", q1 === null ? "unattempted" : (q1 == 1 ? "correct" : "incorrect"));
}
ok_response(q1, "1");
```
...
viewof q2 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q2_selected_t17") ?? "null")}
);

{
  localStorage.setItem("q2_selected_t17", JSON.stringify(q2));
  localStorage.setItem("q2_correct_t17", "4");
  localStorage.setItem("q2_result_t17", q2 === null ? "unattempted" : (q2 == 4 ? "correct" : "incorrect"));
}
ok_response(q2, "4");
```
...
viewof q3 = Inputs.checkbox(
  ...
  {value: JSON.parse(localStorage.getItem("q3_selected_t17") ?? "[]") ?? []}
);

{
  localStorage.setItem("q3_selected_t17", JSON.stringify(q3));
  localStorage.setItem("q3_correct_t17", "1,2,4,6,8,9");
  localStorage.setItem("q3_result_t17", (!q3 || q3.length === 0) ? "unattempted" : (q3.toString() === "1,2,4,6,8,9" ? "correct" : "incorrect"));
}
...
exercise_results$plot_habit_weight <<- "fail"
gradethis::grade_this({
  feedback <- gradethis::code_feedback()
  if (is.null(feedback)) {
    exercise_results$plot_habit_weight <<- "pass"
    pass(random_praise())
  }
...
viewof q_extra1 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q_extra1_selected_t17") ?? "null")}
);

{
  localStorage.setItem("q_extra1_selected_t17", JSON.stringify(q_extra1));
  localStorage.setItem("q_extra1_correct_t17", "3");
  localStorage.setItem("q_extra1_result_t17", q_extra1 === null ? "unattempted" : (q_extra1 == 3 ? "correct" : "incorrect"));
}
...
exercise_results$check_inference_conditions_habit <<- "fail"
gradethis::grade_this({
  feedback <- gradethis::code_feedback()
  if (is.null(feedback)) {
    exercise_results$check_inference_conditions_habit <<- "pass"
    pass(random_praise())
  }
  fail(random_encouragement())
})
...
viewof q4 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q4_selected_t17") ?? "null")}
);

{
  localStorage.setItem("q4_selected_t17", JSON.stringify(q4));
  localStorage.setItem("q4_correct_t17", "2");
  localStorage.setItem("q4_result_t17", q4 === null ? "unattempted" : (q4 == 2 ? "correct" : "incorrect"));
}
ok_response(q4, "2");
```
...
viewof q5 = Inputs.checkbox(
  ...
  {value: JSON.parse(localStorage.getItem("q5_selected_t17") ?? "[]") ?? []}
);

{
  localStorage.setItem("q5_selected_t17", JSON.stringify(q5));
  localStorage.setItem("q5_correct_t17", "2,5");
  localStorage.setItem("q5_result_t17", (!q5 || q5.length === 0) ? "unattempted" : (q5.toString() === "2,5" ? "correct" : "incorrect"));
}
...
viewof q6 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q6_selected_t17") ?? "null")}
);

{
  localStorage.setItem("q6_selected_t17", JSON.stringify(q6));
  localStorage.setItem("q6_correct_t17", "1");
  localStorage.setItem("q6_result_t17", q6 === null ? "unattempted" : (q6 == 1 ? "correct" : "incorrect"));
}
ok_response(q6, "1");
```
...
viewof q7 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q7_selected_t17") ?? "null")}
);

{
  localStorage.setItem("q7_selected_t17", JSON.stringify(q7));
  localStorage.setItem("q7_correct_t17", "1");
  localStorage.setItem("q7_result_t17", q7 === null ? "unattempted" : (q7 == 1 ? "correct" : "incorrect"));
}
ok_response(q7, "1");
```
...
exercise_results$first_inference_run <<- "fail"
gradethis::grade_this({
  feedback <- gradethis::code_feedback()
  if (is.null(feedback)) {
    exercise_results$first_inference_run <<- "pass"
    pass(random_praise())
  }
  fail(random_encouragement())
})
...
function buildQuestionResults() {
  return {
    ...
    questions: {
      ...
      q3_numerical_variables: {
        selected: q3,
        correct_answer: "1,2,4,6,8,9",
        result: (!q3 || q3.length === 0) ? "unattempted" : (q3.toString() === "1,2,4,6,8,9" ? "correct" : "incorrect")
      },
      q_extra1_grouped_summary: {
        selected: q_extra1,
        correct_answer: "3",
        result: q_extra1 === null ? "unattempted" : (q_extra1 == 3 ? "correct" : "incorrect")
      },
      q4_num_groups: {
        selected: q4,
        correct_answer: "2",
