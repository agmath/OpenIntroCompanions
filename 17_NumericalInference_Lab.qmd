...

{
  ...
  localStorage.setItem("q3_correct", "1,2,4,6,8,9");
  localStorage.setItem("q3_result", (!q3 || q3.length === 0) ? "unattempted" : (q3.toString() === "1,2,4,6,8,9" ? "correct" : "incorrect"));
}
...
viewof q_extra1 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q_extra1_selected") ?? "null")}
);

{
  localStorage.setItem("q_extra1_selected", JSON.stringify(q_extra1));
  localStorage.setItem("q_extra1_correct", "3");
  localStorage.setItem("q_extra1_result", q_extra1 === null ? "unattempted" : (q_extra1 == 3 ? "correct" : "incorrect"));
}
