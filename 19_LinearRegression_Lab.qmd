  ...
  btn.onclick = () => {
    if (confirm('Reset all responses for this activity? This cannot be undone.')) {
      Object.keys(localStorage)
        .filter(k => k.endsWith('_selected_t19') || k.endsWith('_correct_t19') || k.endsWith('_result_t19'))
...
viewof q1 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q1_selected_t19") ?? "null")}
);

{
  localStorage.setItem("q1_selected_t19", JSON.stringify(q1));
  localStorage.setItem("q1_correct_t19", "2");
  localStorage.setItem("q1_result_t19", q1 === null ? "unattempted" : (q1 == 2 ? "correct" : "incorrect"));
}
ok_response(q1, "2");
```
...
viewof q2 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q2_selected_t19") ?? "null")}
);

{
  localStorage.setItem("q2_selected_t19", JSON.stringify(q2));
  localStorage.setItem("q2_correct_t19", "1");
  localStorage.setItem("q2_result_t19", q2 === null ? "unattempted" : (q2 == 1 ? "correct" : "incorrect"));
}
ok_response(q2, "1");
```
...
viewof q3 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q3_selected_t19") ?? "null")}
);

{
  localStorage.setItem("q3_selected_t19", JSON.stringify(q3));
  localStorage.setItem("q3_correct_t19", "2");
  localStorage.setItem("q3_result_t19", q3 === null ? "unattempted" : (q3 == 2 ? "correct" : "incorrect"));
}
ok_response(q3, "2");
```
...
viewof q4 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q4_selected_t19") ?? "null")}
);

{
  localStorage.setItem("q4_selected_t19", JSON.stringify(q4));
  localStorage.setItem("q4_correct_t19", "4");
  localStorage.setItem("q4_result_t19", q4 === null ? "unattempted" : (q4 == 4 ? "correct" : "incorrect"));
}
ok_response(q4, "4");
```
...
viewof q5 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q5_selected_t19") ?? "null")}
);

{
  localStorage.setItem("q5_selected_t19", JSON.stringify(q5));
  localStorage.setItem("q5_correct_t19", "1");
  localStorage.setItem("q5_result_t19", q5 === null ? "unattempted" : (q5 == 1 ? "correct" : "incorrect"));
}
ok_response(q5, "1");
```
...
viewof q6 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q6_selected_t19") ?? "null")}
);

{
  localStorage.setItem("q6_selected_t19", JSON.stringify(q6));
  localStorage.setItem("q6_correct_t19", "4");
  localStorage.setItem("q6_result_t19", q6 === null ? "unattempted" : (q6 == 4 ? "correct" : "incorrect"));
}
ok_response(q6, "4");
```
...
viewof q7 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q7_selected_t19") ?? "null")}
);

{
  localStorage.setItem("q7_selected_t19", JSON.stringify(q7));
  localStorage.setItem("q7_correct_t19", "4");
  localStorage.setItem("q7_result_t19", q7 === null ? "unattempted" : (q7 == 4 ? "correct" : "incorrect"));
}
ok_response(q7, "4");
```
...
viewof q8 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q8_selected_t19") ?? "null")}
);

{
  localStorage.setItem("q8_selected_t19", JSON.stringify(q8));
  localStorage.setItem("q8_correct_t19", "1");
  localStorage.setItem("q8_result_t19", q8 === null ? "unattempted" : (q8 == 1 ? "correct" : "incorrect"));
}
ok_response(q8, "1");
```
...
viewof q9 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q9_selected_t19") ?? "null")}
);

{
  localStorage.setItem("q9_selected_t19", JSON.stringify(q9));
  localStorage.setItem("q9_correct_t19", "1");
  localStorage.setItem("q9_result_t19", q9 === null ? "unattempted" : (q9 == 1 ? "correct" : "incorrect"));
}
ok_response(q9, "1");
```
...
viewof q10 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q10_selected_t19") ?? "null")}
);

{
  localStorage.setItem("q10_selected_t19", JSON.stringify(q10));
  localStorage.setItem("q10_correct_t19", "3");
  localStorage.setItem("q10_result_t19", q10 === null ? "unattempted" : (q10 == 3 ? "correct" : "incorrect"));
}
ok_response(q10, "3");
```
...
viewof q11 = Inputs.checkbox(
  ...
  {value: JSON.parse(localStorage.getItem("q11_selected_t19") ?? "[]") ?? []}
);

{
  localStorage.setItem("q11_selected_t19", JSON.stringify(q11));
  localStorage.setItem("q11_correct_t19", "1,6,7,8,12");
  localStorage.setItem("q11_result_t19", (!q11 || q11.length === 0) ? "unattempted" : (q11.toString() === "1,6,7,8,12" ? "correct" : "incorrect"));
}
...
viewof q12 = Inputs.radio(
  ...
  {value: JSON.parse(localStorage.getItem("q12_selected_t19") ?? "null")}
);

{
  localStorage.setItem("q12_selected_t19", JSON.stringify(q12));
  localStorage.setItem("q12_correct_t19", "2");
  localStorage.setItem("q12_result_t19", q12 === null ? "unattempted" : (q12 == 2 ? "correct" : "incorrect"));
}
ok_response(q12, "2");
```
...
viewof q13 = Inputs.checkbox(
  ...
  {value: JSON.parse(localStorage.getItem("q13_selected_t19") ?? "[]") ?? []}
);

{
  localStorage.setItem("q13_selected_t19", JSON.stringify(q13));
  localStorage.setItem("q13_correct_t19", "1,2,3,5,6,7");
  localStorage.setItem("q13_result_t19", (!q13 || q13.length === 0) ? "unattempted" : (q13.toString() === "1,2,3,5,6,7" ? "correct" : "incorrect"));
}
