...
gradethis::grade_this({
  if (.result == .solution) {
    webr::eval_js("localStorage.setItem('ex_mean_sample_one', 'pass')")
    pass(random_praise())
  }
  webr::eval_js("localStorage.setItem('ex_mean_sample_one', 'fail')")
...
gradethis::grade_this_code(
  correct = {
    webr::eval_js("localStorage.setItem('ex_my_data', 'pass')")
    pass(random_praise())
  },
  incorrect = {
    webr::eval_js("localStorage.setItem('ex_my_data', 'fail')")
    fail(random_encouragement())
  }
)
```
